...
public class MeetingsResource {
     ...
     *         body the new meetings, or with status {@code 400 (Bad Request)} if
     *         the meetings has already an ID.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PostMapping("")
    public Mono<ResponseEntity<Meetings>> createMeetings(@Valid @RequestBody Meetings meetings)
     ...
     *         the updated meetings,
     *         or with status {@code 400 (Bad Request)} if the meetings is not
     *         valid,
     *         or with status {@code 500 (Internal Server Error)} if the meetings
     *         couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/{id}")
    public Mono<ResponseEntity<Meetings>> updateMeetings(
            ...
            @Valid @RequestBody Meetings meetings) throws URISyntaxException {
    ...
    /**
     * {@code PATCH  /meetings/:id} : Partial updates given fields of an existing
     * meetings, field will ignore if it is null
     *
     * @param id       the id of the meetings to save.
     * @param meetings the meetings to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
    ...
    public Mono<ResponseEntity<Meetings>> partialUpdateMeetings(
            @PathVariable(value = "id", required = false) final String id,
            @NotNull @RequestBody Meetings meetings) throws URISyntaxException {
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
     *         the meetings, or with status {@code 404 (Not Found)}.
     */
    @GetMapping("/{id}")
