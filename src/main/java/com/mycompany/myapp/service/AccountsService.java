...
public class AccountsService {
     ...
     * @return the list of entities.
     */
    public Flux<Accounts> findAllWithEagerRelationships(Pageable pageable) {
        return accountsRepository.findAllWithEagerRelationships(pageable);
    }
    ...
    public Mono<Accounts> findOne(String id) {
        ...
        return accountsRepository.findOneWithEagerRelationships(id);
    }
