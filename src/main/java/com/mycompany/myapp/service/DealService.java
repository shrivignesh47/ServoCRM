    ...
    public Mono<Deal> partialUpdate(Deal deal) {
        ...
        return dealRepository
            ...
            .map(existingDeal -> {
                ...
                if (deal.getProbability_Percentage() != null) {
                    existingDeal.setProbability_Percentage(deal.getProbability_Percentage());
                }
                if (deal.getCompaign_Source() != null) {
                    existingDeal.setCompaign_Source(deal.getCompaign_Source());
                }
