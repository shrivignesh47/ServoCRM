...
public class Accounts implements Serializable {
    ...
    public Accounts user(User user) {
        this.setUser(user);
        return this;
    }
    ...
    public void setDeals(Set<Deal> deals) {
        if (this.deals != null) {
            this.deals.forEach(i -> i.setAccounts(null));
        }
        if (deals != null) {
            deals.forEach(i -> i.setAccounts(this));
        }
        this.deals = deals;
    }

    public Accounts deals(Set<Deal> deals) {
        this.setDeals(deals);
        return this;
    }

    public Accounts addDeal(Deal deal) {
        this.deals.add(deal);
        deal.setAccounts(this);
        return this;
    }

    public Accounts removeDeal(Deal deal) {
        this.deals.remove(deal);
        deal.setAccounts(null);
        return this;
    }
