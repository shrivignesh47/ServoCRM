...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './whatsappmarketing.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WHATSAPPMARKETING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WHATSAPPMARKETING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WHATSAPPMARKETING actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_WHATSAPPMARKETING actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_WHATSAPPMARKETING actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_WHATSAPPMARKETING actions', async () => {
      const arg = 42666;
