            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('user')}>
                  User <FontAwesomeIcon icon={getSortIconByFieldName('user')} />
                </th>
            ...
            <tbody>
              {attendanceList.map((attendance, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{attendance.timestamp ? <TextFormat type="date" value={attendance.timestamp} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{attendance.event ? <Link to={`/event/${attendance.event.id}`}>{attendance.event.event_name}</Link> : ''}</td>
