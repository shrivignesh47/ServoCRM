...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './meetings.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEETINGS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MEETINGS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MEETINGS actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_MEETINGS actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_MEETINGS actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_MEETINGS actions', async () => {
      const arg = 42666;
