          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('probability_Percentage')}>
                  Probability Percentage <FontAwesomeIcon icon={getSortIconByFieldName('probability_Percentage')} />
                </th>
                <th className="hand" onClick={sort('compaign_Source')}>
                  Compaign Source <FontAwesomeIcon icon={getSortIconByFieldName('compaign_Source')} />
                </th>
                ...
                <th>
                  Accounts <FontAwesomeIcon icon="sort" />
                </th>
                <th>
            ...
            <tbody>
              {dealList.map((deal, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{deal.stage}</td>
                  <td>{deal.type}</td>
                  <td>{deal.probability_Percentage}</td>
                  <td>{deal.compaign_Source}</td>
                  <td>{deal.description}</td>
                  <td>{deal.user ? deal.user.login : ''}</td>
                  <td>{deal.accounts ? <Link to={`/accounts/${deal.accounts.id}`}>{deal.accounts.account_owner}</Link> : ''}</td>
                  <td>{deal.contacts ? <Link to={`/contacts/${deal.contacts.id}`}>{deal.contacts.first_name}</Link> : ''}</td>
                  <td>{deal.lead ? <Link to={`/lead/${deal.lead.id}`}>{deal.lead.lead_source}</Link> : ''}</td>
