...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './marketing.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MARKETING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MARKETING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MARKETING actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_MARKETING actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_MARKETING actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_MARKETING actions', async () => {
      const arg = 42666;
