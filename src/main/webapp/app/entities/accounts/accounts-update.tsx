...
export const AccountsUpdate = () => {
  ...
  const acc_typeValues = Object.keys(acc_type);
          ...
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Account Type" id="accounts-account_type" name="account_type" data-cy="account_type" type="select">
                {acc_typeValues.map(acc_type => (
                  <option value={acc_type} key={acc_type}>
                    {acc_type}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField id="accounts-user" name="user" data-cy="user" label="User" type="select" required>
                <option value="" key="0" />
                {users
