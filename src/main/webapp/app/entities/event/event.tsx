          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('event_name')}>
                  Event Name <FontAwesomeIcon icon={getSortIconByFieldName('event_name')} />
                </th>
                <th className="hand" onClick={sort('event_date')}>
                  Event Date <FontAwesomeIcon icon={getSortIconByFieldName('event_date')} />
                </th>
                <th className="hand" onClick={sort('registrations')}>
                  Registrations <FontAwesomeIcon icon={getSortIconByFieldName('registrations')} />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {eventList.map((event, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{event.event_date ? <TextFormat type="date" value={event.event_date} format={APP_LOCAL_DATE_FORMAT} /> : null}</td>
