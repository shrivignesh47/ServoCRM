    ...
    <div className={`sidebar ${collapsed ? 'collapsed' : ''}`}>
      ...
      <Nav className="flex-column">
        ...
        <Nav.Link onClick={toggleMarketingMenu} className="nav-item">
          ...
          <FontAwesomeIcon style={{ marginLeft: '1vh' }} icon={MarketingOpen ? faChevronUp : faChevronDown} />
        </Nav.Link>
        {MarketingOpen && (
          <Nav className="excel-submenu">
        ...
        <Nav.Link onClick={() => setSelectedMenu('MarketPlace')} className="nav-item">
          <FontAwesomeIcon icon={faStore} />
          <span className="nav-text">MarketPlace</span>
        </Nav.Link>
        <Nav.Link onClick={() => setSelectedMenu('ManageMeeting')} className="nav-item">
          <FontAwesomeIcon icon={faCalendarAlt} />
          <span className="nav-text">Manage Meeting</span>
        </Nav.Link>
        <Nav.Link onClick={() => setSelectedMenu('EventManagement')} className="nav-item">
          <FontAwesomeIcon icon={faBullhorn} />
